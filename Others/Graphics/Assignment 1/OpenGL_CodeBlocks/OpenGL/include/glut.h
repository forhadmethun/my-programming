...
/* To enable automatic SGI Graphics for Windows library usage for GLUT,
   define GLUT_USE_SGI_OPENGL in your compile preprocessor options.  */
#  ifdef GLUT_USE_SGI_OPENGL
#   pragma comment (lib, "opengl.lib")    /* link with SGI Graphics for Windows lib */
#   pragma comment (lib, "glu.lib")       /* link with SGI Graphics Utility lib */
#   pragma comment (lib, "glut.lib")      /* link with Win32 GLUT for SGI Graphics lib */
#  else
#   pragma comment (lib, "opengl32.lib")  /* link with Microsoft Graphics lib */
#   pragma comment (lib, "glu32.lib")     /* link with Microsoft Graphics Utility lib */
