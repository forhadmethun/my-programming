...
m = input("[?] Enter message to encrypt: ").encode()
c = encrypt(n, e, m)
...
c = c[2:]
s = now()
r = send([0x00, 0x08, p1, p2, len(c)] + [byte for byte in c]) # omit Le as a workaround for OMNIKEY 1021 and Feitian-D11CR T=0 bug
